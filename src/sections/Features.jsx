      ...
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            ...
            <ul className="relative flex justify-around flex-grow px-[58] border-2 border-s3 rounded-7xl max-md:hidden ">
              <div className="absolute bg-s3/20 too-[38%] left-0 right-0 w-full h-[1px] z-10" />
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <h3 className="relative z-2 max-w-36 mx-auto my-8 base-small text-center uppercase">
                    {title}
                  </h3>
                </li>
              ))}
